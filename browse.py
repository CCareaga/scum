...
class FileTreeWidget(FlagFileWidget):
    ...
    def __init__(self, node, display):
        self.__super.__init__(node, display)
        path = node.get_value()
...
class FileNode(urwid.TreeNode):
    ...
    def __init__(self, path, display, parent=None):
        self.display = display
    ...
    def load_parent(self):
        ...
        parent = DirectoryNode(parentname, display)
        parent.set_child_node(self.get_key(), self)
        return parent

    def load_widget(self):
        return FileTreeWidget(self, self.display)
...
class DirectoryNode(urwid.ParentNode):
    ...
    def load_parent(self):
        parentname, myname = os.path.split(self.get_value())
        parent = DirectoryNode(parentname, self.display)
        parent.set_child_node(self.get_key(), self)
        return parent
...
class DirectoryBrowser:
    ...
    def __init__(self):
        ...
        self.view = urwid.Frame(
            urwid.AttrWrap(self.listbox, 'header'))
